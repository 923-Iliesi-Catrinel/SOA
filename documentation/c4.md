...
C4Container
    ...
    %% MICROSERVICES (The 4 Core Nodes)
    ...
    Container(kafka, "Kafka Cluster", "Apache Kafka", "Telemetry Streaming.")
...
C4Component
    ...
    Container_Boundary(notif_app, "Notification Service") {
        ...
        Component(logic, "Alert Engine", "JS Function", "Checks thresholds (Temp > 8°C). Filters spam.")
